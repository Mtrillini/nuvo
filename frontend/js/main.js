...
function getNavbarHTML() {
  return `
    <header class="navbar" id="main-navbar">
      ...
      <nav class="navbar__nav">
        ...
        <div class="navbar__dropdown">
          <a href="${PAGES_BASE}/productos" class="navbar__link" data-page="productos">PERFUMES</a>
          <div class="navbar__dropdown-menu">
            <a href="${PAGES_BASE}/productos?genero=femenino" class="navbar__dropdown-item">FEMENINOS</a>
            <a href="${PAGES_BASE}/productos?genero=masculino" class="navbar__dropdown-item">MASCULINOS</a>
          </div>
        </div>
        <a href="${PAGES_BASE}/nosotros" class="navbar__link" data-page="nosotros">SOBRE NÜVE</a>
      </nav>
    ...
    <div class="mobile-menu" id="mobile-menu">
      ...
      <a href="${PAGES_BASE}/productos">Perfumes</a>
      <a href="${PAGES_BASE}/productos?genero=femenino">Perfumes Femeninos</a>
      <a href="${PAGES_BASE}/productos?genero=masculino">Perfumes Masculinos</a>
      <a href="${PAGES_BASE}/nosotros">Sobre NÜVE</a>
